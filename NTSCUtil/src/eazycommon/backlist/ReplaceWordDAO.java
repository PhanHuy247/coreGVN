    ...
    public static int getLastestVersion() throws EazyException {
     ...
     public static List<String> getList(Integer flag) throws EazyException {
        ...
        try {
            DBCursor cursor;
//            if (flag != null) {
                BasicDBObject findObj = new BasicDBObject(SettingdbKey.REPLACE_WORD.FLAG, 1);
                cursor = coll.find(findObj);
//            } else {
//                BasicDBObject findObj = new BasicDBObject(SettingdbKey.REPLACE_WORD.FLAG, new BasicDBObject("$exists", true));
//                cursor = coll.find(findObj);
//            }
