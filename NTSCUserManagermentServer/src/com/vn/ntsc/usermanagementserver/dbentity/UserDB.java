...
//    public Integer indecent;
    ...
    public static UserDB fromDBObject(DBObject dbObj) {
        ...
        Integer hasAccountEmail = (Integer) dbObj.get(hasAccountEmailKey);
        if (hasAccountEmail != null) {
            user.hasAccountEmail = hasAccountEmail;
        }
        ...
        if (point != null) {
            user.point = (new Double(point.toString())).intValue();
        }
...
//            user.indecent = (Integer) dbObj.get(indecentKey);
        ...
        String idNumber = (String) dbObj.get(idNumberKey);
        if (idNumber != null) {
            user.idNumber = idNumber;
        }
        String phoneNumber = (String) dbObj.get(phoneNumberKey);
        if (phoneNumber != null) {
            user.phoneNumber = phoneNumber;
        }
        
        List<Integer> rateList = (List<Integer>) dbObj.get(rateValueKey);
        user.rateValue = rateList;
...
//        }
        ...
        if (idNumber != null) {
            dbObject.append(idNumberKey, idNumber);
        }

        if (phoneNumber != null) {
            dbObject.append(phoneNumberKey, phoneNumber);
        }
...
//        }
        user.userType = this.accountType.longValue();
        ...
        if (this.body_type != null){
            user.body_type = this.body_type.longValue(); 
        }
...
//        user.applicationName = uniquename;
        ...
        Integer hasAccountEmail = this.hasAccountEmail;
        if (hasAccountEmail != null) {
            user.hasAccountEmail = hasAccountEmail;
        }
...
//            }
        ...
        List<Integer> listRate = this.rateValue;
        if (listRate != null){
            user.rateValue = listRate;
        }
...
//            result.bonusFlag = Constant.EMAIL_FLAG;
        ...
        String idNumber = entity.idNumber;
        if (idNumber != null) {
