 ...
 * @author Admin
 */
public class GetLikeNotification implements IApiAdapter {
...
//            Collection<String> deactiveList = BlackListManager.toList();
            ...
            result = NotificationDAO.getNotificationListByType(userId, date.getTime(), take, blockList, Constant.NOTIFICATION_TYPE_VALUE.LIKE_MY_BUZZ_NOTI);
            UserDAO.updateLikeNotificationReadTime(userId, time.getTime());
