 ...
 * @author RuAc0n
 */
public class ListCheckOutApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj, Date time) {
        ...
        try {
            ...
            Map<String, FollowingUser> mapCheckout = CheckOutDAO.getCheckOutList(userId, listCheckout);
...
//            }
            ...
            List<FollowingUser> listReturn = new ArrayList<>();
            if (skip < listRespond.size()) {
                ...
                listReturn = listRespond.subList((int) startIndex, (int) endIndex);
//                UserActivityDAO.getListStatus(respondList);
            }
            // update last time get list checkout
            LastTimeGetDAO.updateLastGetCheckOut(userId, time.getTime(), null);
            result = new ListEntityRespond(ErrorCode.SUCCESS, listReturn);
//            }
