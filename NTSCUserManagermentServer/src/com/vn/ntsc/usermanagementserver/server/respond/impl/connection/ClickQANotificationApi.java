...
import com.vn.ntsc.usermanagementserver.dao.impl.QANotificationDAO;
 ...
 */
public class ClickQANotificationApi implements IApiAdapter{
    ...
    public Respond execute(JSONObject obj, Date time) {
        ...
        try {
            ...
            boolean check = QANotificationDAO.checkIfExistClickedUser(userId, pushId);
            if(check){
                QANotificationDAO.addClickedUser(userId, pushId);
            }
