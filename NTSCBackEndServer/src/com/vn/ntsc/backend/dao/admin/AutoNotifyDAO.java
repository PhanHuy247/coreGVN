...
public class AutoNotifyDAO {
    ...
    static {
        try {
            coll = DBManager.getSettingDB().getCollection(SettingdbKey.AUTO_MESSAGE.AUTO_NOTIFY_COLLECTION);
        } catch (Exception ex) {
            Util.addErrorLog(ex);
        }
    }
        ...
        try {
            ...
            while (cur.hasNext()) {
                ...
                if (flag == Constant.FLAG.ON) {
                    ...
                    result.put(id, new AutoNotify(content, url, ip, id, timeStr, query, flag));
                }
            }
    ...
    public static SizedListData getList(Integer flag, Long skip, Long take) throws EazyException {
        ...
        try {
            ...
            while (cursor.hasNext()) {
               ...
               AutoNotify autoNotify = new AutoNotify(content, url, id, time, flg, receiverNumber);
    ...
    public static AutoNotify get(String id) throws EazyException {
        try {
            ...
            AutoNotify autoNotify = new AutoNotify(id, content, url, timeStr, query, receiverNumber);
            autoNotify.clickUserNumber = clickedUsersNumber;
            autoNotify.ratioClickedUser = rationClickedUser;
            return autoNotify;
        } catch (Exception ex) {
