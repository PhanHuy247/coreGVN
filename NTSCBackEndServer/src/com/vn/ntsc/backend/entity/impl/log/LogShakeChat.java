 ...
 * @author RuAc0n
 */
public class LogShakeChat extends TwoObjectLog implements IEntity{
...
//        englishHeader = new ArrayList<String>();
        ...
        keys.add(Headers.shake_user_id);
        keys.add(Headers.shake_user_name);
        keys.add(Headers.shake_user_type);
        keys.add(Headers.shake_user_email);
        keys.add(Headers.shake_user_group);
        keys.add(Headers.shake_user_cm_code);
        keys.add(Headers.shake_user_ip);
        keys.add(Headers.shaked_user_id);
        keys.add(Headers.shaked_user_name);
        keys.add(Headers.shaked_user_type);
        keys.add(Headers.shaked_user_email);
        keys.add(Headers.shaked_user_group);
        keys.add(Headers.shaked_user_cm_code);
        keys.add(Headers.shake_time);
        headers.addAll(keys);
