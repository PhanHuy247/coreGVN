 ...
 * @author Admin
 */
public class AutoNotify extends Message{
    ...
    public AutoNotify(String content, String url, String ip,  String id, String time, JSONObject query, int flag) {
        super(id, time, content, query, flag);
        this.url = url;
        this.ip = ip;
    }

    public AutoNotify(String content, String url, String id, String time, int flag, Integer receiverNumber) {
        super(id, time, content, flag, receiverNumber);
        this.url = url;
    }
    
    public AutoNotify( String id,  String content, String url, String time, JSONObject query, Integer receiverNumber) {
        this.id = id;
