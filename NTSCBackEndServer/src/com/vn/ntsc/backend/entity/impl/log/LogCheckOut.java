 ...
 * @author RuAc0n
 */
public class LogCheckOut extends TwoObjectLog implements IEntity{
...
//        englishHeader = new ArrayList<String>();        
        ...
        keys.add(Headers.check_user_id);
        keys.add(Headers.check_user_name);
        keys.add(Headers.check_user_type);
        keys.add(Headers.check_user_email);
        keys.add(Headers.check_user_group);
        keys.add(Headers.check_user_cm_code);
        keys.add(Headers.check_user_ip);
        keys.add(Headers.checked_user_id);
        keys.add(Headers.checked_user_name);
        keys.add(Headers.checked_user_type);
        keys.add(Headers.checked_user_email);
        keys.add(Headers.checked_user_group);
        keys.add(Headers.checked_user_cm_code);
        keys.add(Headers.check_time);
        headers.addAll(keys);
//        headers = keys;
