 ...
 * @author RuAc0n
 */
public class LogImageReport extends TwoObjectLog implements IEntity{
...
//        jsonJapaneseType = new JSONObject();
        ...
        //image type
        value = new JSONObject();
        value.putAll(TypeValue.en_image_type);
        jsonEnglishType.put(ParamKey.IMAGE_TYPE, value);
        value = new JSONObject();
        value.putAll(TypeValue.jp_image_type);
        jsonJapaneseType.put(ParamKey.IMAGE_TYPE, value);
        
        //report type
        value = new JSONObject();
        value.putAll(TypeValue.en_report_type);
        jsonEnglishType.put(ParamKey.REPORT_TYPE, value);
        value = new JSONObject();
        value.putAll(TypeValue.jp_report_type);
        jsonJapaneseType.put(ParamKey.REPORT_TYPE, value);        
...
//        englishHeader = new ArrayList<String>();
        ...
        keys.add(Headers.image_id);
        keys.add(Headers.image_type);
        keys.add(Headers.reported_user_id);
        keys.add(Headers.reported_user_name);
        keys.add(Headers.reported_user_type);
        keys.add(Headers.reported_user_email);
        keys.add(Headers.reported_user_group);
        keys.add(Headers.reported_user_cm_code);
        keys.add(Headers.report_user_id);
        keys.add(Headers.report_user_name);
        keys.add(Headers.report_user_type);
        keys.add(Headers.report_user_email);
        keys.add(Headers.report_user_group);
        keys.add(Headers.report_user_cm_code);
        keys.add(Headers.report_user_ip);        
        keys.add(Headers.report_type);
        keys.add(Headers.report_time);
        headers.addAll(keys);
...
//        headers = keys;
    ...
    public JSONObject toJsonObject() {
        ...
        if(this.reportType != null){
            jo.put(reportTypeKey, this.reportType);
        }
