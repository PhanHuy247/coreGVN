 ...
 * @author RuAc0n
 */
public class LogFavourist extends TwoObjectLog implements IEntity{
...
//        jsonJapaneseType = new JSONObject();
        ...
        //block type
        value = new JSONObject();
        value.putAll(TypeValue.en_favourist_type);
        jsonEnglishType.put(ParamKey.TYPE, value);
        value = new JSONObject();
        value.putAll(TypeValue.jp_favourist_type);
...
//        englishHeader = new ArrayList<String>();
        ...
        keys.add(Headers.favourited_user_id);
        keys.add(Headers.favourited_user_name);
        keys.add(Headers.favourited_user_type);
        keys.add(Headers.favourited_user_email);
        keys.add(Headers.favourited_user_group);
        keys.add(Headers.favourited_user_cm_code);
        keys.add(Headers.favourited_user_ip);
        keys.add(Headers.favourist_user_id);
        keys.add(Headers.favourist_user_name);
        keys.add(Headers.favourist_user_type);
        keys.add(Headers.favourist_user_email);
        keys.add(Headers.favourist_user_group);
        keys.add(Headers.favourist_user_cm_code);
        keys.add(Headers.favourist_type);
        keys.add(Headers.favourist_time);
        headers.addAll(keys);
