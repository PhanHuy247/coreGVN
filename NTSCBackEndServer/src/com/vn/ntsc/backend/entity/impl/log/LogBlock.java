 ...
 * @author RuAc0n
 */
public class LogBlock extends TwoObjectLog implements IEntity {
...
//        jsonJapaneseType = new JSONObject();
        ...
        //block type
        value = new JSONObject();
        value.putAll(TypeValue.en_block_type);
        jsonEnglishType.put(ParamKey.TYPE, value);
        value = new JSONObject();
        value.putAll(TypeValue.jp_block_type);
...
//        englishHeader = new ArrayList<String>();
        ...
        keys.add(Headers.block_user_id);
        keys.add(Headers.block_user_name);
        keys.add(Headers.block_user_type);
        keys.add(Headers.block_user_email);
        keys.add(Headers.block_user_group);
        keys.add(Headers.block_user_cm_code);
        keys.add(Headers.block_user_ip);
        keys.add(Headers.blocked_user_id);
        keys.add(Headers.blocked_user_name);
        keys.add(Headers.blocked_user_type);
        keys.add(Headers.blocked_user_email);
        keys.add(Headers.blocked_user_group);
        keys.add(Headers.blocked_user_cm_code);
        keys.add(Headers.block_type);
        keys.add(Headers.block_time);
        headers.addAll(keys);
...
//        headers = keys;
    ...
    public JSONObject toJsonObject() {
        ...
        if (this.getPartnerId() != null) {
            jo.put(partnerIdKey, this.getPartnerId());
        }
