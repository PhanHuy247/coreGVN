 ...
 * @author hungdt
 */
public class AutoNewsNotify extends Message{
    ...
    public AutoNewsNotify(String content, String url, String ip,  String id, String time, JSONObject query, int flag) {
        super(id, time, content, query, flag);
        this.url = url;
        this.ip = ip;
    }

    public AutoNewsNotify(String content, String url, String id, String time, int flag, Integer receiverNumber) {
