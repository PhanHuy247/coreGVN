 ...
 * @author RuAc0n
 */
public class SearchReportImageApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = ReportImageDAO.listLog(imageId, listRequestId, listPartnerId, fromTime,
                    toTime, reportType, imageType, sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, null, new LogImageReport());
            }
