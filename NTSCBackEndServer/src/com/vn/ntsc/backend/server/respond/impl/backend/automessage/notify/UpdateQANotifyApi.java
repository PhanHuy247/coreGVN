 ...
 */
public class UpdateQANotifyApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            AutoQANotifyDAO.update(id, url, message, time);
            
            AutoQANotify msg = (AutoQANotify) MessageContainer.getMessage(id);
