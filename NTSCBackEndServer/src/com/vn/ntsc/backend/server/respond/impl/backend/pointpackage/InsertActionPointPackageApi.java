 ...
 * @author RuAc0n
 */
public class InsertActionPointPackageApi implements IApiAdapter {
    ...
    static {
        ...
        keys.put("first_purchase_point", 7);
...
//            String des = Util.getStringParam(obj, ParamKey.DESCRIPTION);
            ...
            if (first_purchase_point<=0){
                respond = new EntityRespond(keys.get("first_purchase_point"));
                return respond;                
            }
...
//            actionPointPacket.description = des;
            ...
            String id = ActionPointPacketDAO.insertMultiapp(applicationId, actionPointPacket, type.intValue());
