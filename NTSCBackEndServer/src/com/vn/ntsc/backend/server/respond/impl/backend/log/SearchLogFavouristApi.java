...
import com.vn.ntsc.backend.dao.log.LogFavouristDAO;
 ...
 * @author RuAc0n
 */
public class SearchLogFavouristApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = LogFavouristDAO.listLog(listRequestId, listPartnerId, fromTime, toTime,
                    sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, null, new LogFavourist());
            }
