 ...
 * @author RuAc0n
 */
public class UpdateAutoNotifyApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            AutoNotifyDAO.update(id, url, message, time);
            
            AutoNotify msg = (AutoNotify) MessageContainer.getMessage(id);
