...
import com.vn.ntsc.backend.dao.log.LogLookDAO;
 ...
 * @author RuAc0n
 */
public class SearchLogLookApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = LogLookDAO.listLog(listId, fromTime, toTime, fromPoint, toPoint, sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, new LogLook(), null);
            }
