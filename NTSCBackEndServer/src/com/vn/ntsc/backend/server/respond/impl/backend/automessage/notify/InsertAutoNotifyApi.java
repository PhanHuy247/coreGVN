 ...
 * @author RuAc0n
 */
public class InsertAutoNotifyApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            String id = AutoNotifyDAO.insert(url, message, ip, time, obj.toJSONString());
            // create message
            Message msg = new AutoNotify(message, url, ip, id, time, obj, Constant.FLAG.ON);
