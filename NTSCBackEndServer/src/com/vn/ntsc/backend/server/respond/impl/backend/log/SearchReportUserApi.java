...
import com.vn.ntsc.backend.dao.log.ReportUserDAO;
 ...
 * @author RuAc0n
 */
public class SearchReportUserApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = ReportUserDAO.listLog(listRequestId, listPartnerId, fromTime, toTime,
                    reportType, sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, null, new LogUserReport());
            }
