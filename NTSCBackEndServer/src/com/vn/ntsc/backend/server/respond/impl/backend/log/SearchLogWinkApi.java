...
import com.vn.ntsc.backend.dao.log.LogWinkDAO;
 ...
 * @author RuAc0n
 */
public class SearchLogWinkApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = LogWinkDAO.listLog(listRequestId, listPartnerId, fromTime, toTime,
                    sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, null, new LogWink());
            }
