...
import com.vn.ntsc.backend.entity.impl.cmcode.InsertAfficiateData;
 ...
 * @author RuAc0n
 */
public class InsertAfficiateApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            String affId = AfficiateDAO.insert(affName, affPassword, affEmail, flag.intValue(), affLoginId);
            respond = new EntityRespond(ErrorCode.SUCCESS, new InsertAfficiateData(affId));
