 ...
 * @author hungdt
 */
public class InsertAutoNewsNotifyApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            String id = AutoNewsNotifyDAO.insert(url, message, ip, time, obj.toJSONString());
            // create message
            Message msg = new AutoNewsNotify(message, url, ip, id, time, obj, Constant.FLAG.ON);
