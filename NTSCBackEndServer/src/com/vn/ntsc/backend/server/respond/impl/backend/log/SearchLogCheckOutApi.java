...
import com.vn.ntsc.backend.dao.log.LogCheckOutDAO;
 ...
 * @author RuAc0n
 */
public class SearchLogCheckOutApi implements IApiAdapter {
    ...
    public Respond execute(JSONObject obj) {
        ...
        try {
            ...
            SizedListData data = LogCheckOutDAO.listLog(listRequestId, listPartnerId, fromTime, toTime,
                    sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, null, new LogCheckOut());
            }
