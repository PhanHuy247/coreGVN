 ...
 * @author RuAc0n
 */
public class SearchLogWinkBombApi implements IApiAdapter {
...
//            toTime = getToTime(toTime);
            ...
            String mess = Util.getStringParam(obj, "message");
            Long bombNumber = Util.getLongParam(obj, "bomb_num");
            ...
            SizedListData data = LogWinkBombDAO.listLog(listId, fromTime, toTime, fromPoint, toPoint,
                    mess, bombNumber, sort, order, skip, take, isCsv);
            if (isCsv) {
                String api = Util.getStringParam(obj, ParamKey.API_NAME);
                return LogProcess.createCSV(api, csv, data.ll, new LogWinkBomb(), null);
            }
