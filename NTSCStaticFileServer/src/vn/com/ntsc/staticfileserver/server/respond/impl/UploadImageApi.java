 ...
 * @author RuAc0n
 */
public class UploadImageApi implements IApiAdapter {
    ...
    public Respond execute(Request request, Date time) {
        ...
        String a = new String(arrayImageInput);
        ...
        try {
            ...
            Util.addDebugLog("UploadImageVersionApi " + is_free);
            ...
            if (imageCat.equals(Constant.IMAGE_KIND_STRING.THUMBNAIL_VIDEO)) {
                ...
                try {
                    ...
                    Util.addDebugLog("UploadImageVersionApi 2" + is_free);
            ...
            try {
                ...
                Util.addDebugLog("UploadImageVersionApi 3 " + is_free);
                //insert image collection
                imageId = ImageDAO.insertImage2(imageUrl, is_free);
                Util.addDebugLog("UploadImageVersionApi 4 " + is_free);
