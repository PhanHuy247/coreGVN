 ...
 */
public class ReviewBuzzTextApi implements IApiAdapter{
    ...
    public void execute(JSONObject obj, Date time) {
        try {
            ...
            if (toUserid != null && buzzId != null) {
                JSONObject msg = null;
//                JSONObject msg = MsgUtil.iosPayload_buzz(api, null, toUserid, buzzId);
//                send(msg, toUserid);
//                LogNotificationDAO.addLog(toUserid, Params.getNotiType(api), null, Util.getGMTTime(), ip);
                ...
                if (notification.andgAlert != null && notification.andgAlert == 0) { //OFF push noti
                    msg = MsgUtil.iosPayload_buzz(api, null, toUserid, buzzId, true,avaUrl,textBuzz,urlImageBuzz,gender);
                } else if (notification.andgAlert != null && notification.andgAlert == 1) {//ON push noti
                    msg = MsgUtil.iosPayload_buzz(api, null, toUserid, buzzId, false,avaUrl,textBuzz,urlImageBuzz,gender);
                }
