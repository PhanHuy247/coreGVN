...
public class UserMonthStatisticDAO {
    ...
    static{
         try{
             coll = DBLoader.getStatisticDB().getCollection( StatisticdbKey.USER_MONTH_STATISTIC_COLLECTION );
        } catch( Exception ex ) {
            Util.addErrorLog(ex);            
        }
    }
    
    public static boolean update(String month, String day,int onlineIos, int onlineFemaleIos, int onlineMaleIos,
            int onlineAndroid, int onlineFemaleAndroid, int onlineMaleAndroid,
            ...
            int activeUserIos, int activeUserAndroid, int totalNumber,
        ...
        try{
            ...
            if(obj == null){
                ...
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_FEMALE_IOS, onlineFemaleIos);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_MALE_IOS, onlineMaleIos);
                
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_ANDROID, onlineAndroid);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_FEMALE_ANDROID, onlineFemaleAndroid);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_MALE_ANDROID, onlineMaleAndroid);
                ...
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_IOS, newNumberFemaleIos);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_IOS, newNumberMaleIos);
                
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_ANDROID, newNumberAndroid);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_ANDROID, newNumberFemaleAndroid);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_ANDROID, newNumberMaleAndroid);
                
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_WEB, newNumberWeb);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_WEB, newNumberFemaleWeb);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_WEB, newNumberMaleWeb);
                
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.VIDEO_CALL, videoCall);
                updateObj.append(StatisticdbKey.USER_MONTH_STATISTIC.VOICE_CALL, voiceCall);
                ...
                String fieldOnlineFemaleIos = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_FEMALE_IOS;
                String fieldOnlineMaleIos = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_MALE_IOS;
                ...
                String fieldOnlineFemaleAndroid = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_FEMALE_ANDROID;
                String fieldOnlineMaleAndroid = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.ONLINE_USER_MALE_ANDROID;
                ...
                String fieldNewFemaleIos = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_IOS;
                String fieldNewMaleIos = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_IOS;
                
                String fieldNewAndroid = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_ANDROID;
                String fieldNewFemaleAndroid = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_ANDROID;
                String fieldNewMaleAndroid = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_ANDROID;
                
                String fieldNewWeb = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_WEB;
                String fieldNewFemaleWeb = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_FEMALE_WEB;
                String fieldNewMaleWeb = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.NEW_USER_MALE_WEB;
                
                String fieldTotalMale = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.TOTAL_USER;
                
                String fieldVideoCall = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.VIDEO_CALL;
                String fieldVoiceCall = StatisticdbKey.USER_MONTH_STATISTIC.LIST_DAY + ".$." + StatisticdbKey.USER_MONTH_STATISTIC.VOICE_CALL;
                ...
                updateObj.append(fieldOnlineFemaleIos, onlineFemaleIos);
                updateObj.append(fieldOnlineMaleIos, onlineMaleIos);
                
                updateObj.append(fieldOnlineAndroid, onlineAndroid);           
                updateObj.append(fieldOnlineFemaleAndroid, onlineFemaleAndroid);           
                updateObj.append(fieldOnlineMaleAndroid, onlineMaleAndroid);    
