...
import com.vn.ntsc.otherservice.entity.impl.Message;
import com.vn.ntsc.otherservice.entity.impl.SizedListData;
...
public class AutoNewsNotifyDAO {
    ...
    static {
        try {
            coll = DBLoader.getSettingDB().getCollection(SettingdbKey.AUTO_MESSAGE.AUTO_NEWS_NOTIFY_COLLECTION);
    ...
    public static List<AutoNewsNotify> getAll() throws EazyException {
         List<AutoNewsNotify> newsList = null;
        try {
            ...
            while (cur.hasNext()) {
                ...
                AutoNewsNotify autoNews = new AutoNewsNotify();
                if (flag == Constant.FLAG.ON) {
                    ...
                    autoNews.setId(id);
                    autoNews.setContent(content);
                    autoNews.setIp(ip);
                    autoNews.setTime(timeStr);
                    autoNews.setUrl(url);
                    newsList.add(autoNews);
                }
            }
