...
public class User implements Comparable<User>, IEntity {
    ...
    private static final String userTypeKey = "type"; //Linh 10/17/2016 #4959
    ...
    public static final String havePurchasedKey = "have_purchase";
    public Boolean havePurchased;

    public static final String applicationIdKey = "application_id";
    public String applicationId;
    
    public static final String longitudeKey = "long";
    ...
    public JSONObject toJsonObject() {
        ...
        if (this.firstPurchaseTime != null){
            jo.put(firstPurchaseTimeKey, firstPurchaseTime);
        }
        ...
        if (havePurchased != null) {
            jo.put(havePurchasedKey, havePurchased);
        }
...
//        this.fbId = null;
        ...
        this.isPurchased = obj.get(isPurchasedKey) != null ? new Boolean(obj.get(isPurchasedKey).toString()) : null;      
    }
